...
public class Conferences extends AppCompatActivity {
    ...
    private final int[] pics = {R.drawable.conf1, R.drawable.conf2, R.drawable.conf3, R.drawable.conf4, R.drawable.conf5, R.drawable.conf6, R.drawable.conf7, R.drawable.conf8, R.drawable.conf9, R.drawable.conf10};
    ...
    private final String eventType = "Conferences";
    ...
    private void getData() {
        ...
        AndroidNetworking.get("https://api.predicthq.com/v1/events?category=conferences&limit=10")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject events) {
                        ...
                        sliderAdapter = new SliderAdapter(pics, arr.length(), new Conferences.OnCardClickListener());
    ...
    private void onActiveCardChange(int pos) {
        ...
        placeSwitcher.setInAnimation(Conferences.this, animV[0]);
        placeSwitcher.setOutAnimation(Conferences.this, animV[1]);
        placeSwitcher.setText(places[pos % places.length]);

        clockSwitcher.setInAnimation(Conferences.this, animV[0]);
        clockSwitcher.setOutAnimation(Conferences.this, animV[1]);
    ...
    private class TextViewFactory implements  ViewSwitcher.ViewFactory {
        ...
        public View makeView() {
            final TextView textView = new TextView(Conferences.this);
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
                textView.setTextAppearance(Conferences.this, styleId);
            } else {
    ...
    private class ImageViewFactory implements ViewSwitcher.ViewFactory {
        @Override
        public View makeView() {
            final ImageView imageView = new ImageView(Conferences.this);
    ...
    private class OnCardClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (clickedPosition == activeCardPosition) {
                final Intent intent = new Intent(Conferences.this, DetailsActivity.class);
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    final ActivityOptions options = ActivityOptions
                            .makeSceneTransitionAnimation(Conferences.this, sharedView, "shared");
