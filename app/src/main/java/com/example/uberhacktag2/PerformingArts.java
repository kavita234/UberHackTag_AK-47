...
public class PerformingArts extends AppCompatActivity {
    ...
    private final int[] pics = {R.drawable.p1, R.drawable.p2, R.drawable.p3, R.drawable.p4, R.drawable.p5, R.drawable.p1, R.drawable.p2, R.drawable.p3, R.drawable.p4, R.drawable.p5};
    ...
    private final String eventType = "Performing Arts";
    ...
    private void getData() {
        ...
        AndroidNetworking.get("https://api.predicthq.com/v1/events?category=performing-arts&limit=10")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject events) {
                        ...
                        sliderAdapter = new SliderAdapter(pics, arr.length(), new PerformingArts.OnCardClickListener());
                        setContentView(R.layout.performingarts);
    ...
    private void onActiveCardChange(int pos) {
        ...
        placeSwitcher.setInAnimation(PerformingArts.this, animV[0]);
        placeSwitcher.setOutAnimation(PerformingArts.this, animV[1]);
        placeSwitcher.setText(places[pos % places.length]);

        clockSwitcher.setInAnimation(PerformingArts.this, animV[0]);
        clockSwitcher.setOutAnimation(PerformingArts.this, animV[1]);
    ...
    private class TextViewFactory implements  ViewSwitcher.ViewFactory {
        ...
        public View makeView() {
            final TextView textView = new TextView(PerformingArts.this);
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
                textView.setTextAppearance(PerformingArts.this, styleId);
            } else {
    ...
    private class ImageViewFactory implements ViewSwitcher.ViewFactory {
        @Override
        public View makeView() {
            final ImageView imageView = new ImageView(PerformingArts.this);
    ...
    private class OnCardClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (clickedPosition == activeCardPosition) {
                final Intent intent = new Intent(PerformingArts.this, DetailsActivity.class);
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    final ActivityOptions options = ActivityOptions
                            .makeSceneTransitionAnimation(PerformingArts.this, sharedView, "shared");
