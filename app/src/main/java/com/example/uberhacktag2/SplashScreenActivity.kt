...
import com.example.uberhacktag2.simulator.Simulator
...
class SplashScreenActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Places.initialize(applicationContext, getString(R.string.google_maps_key1))
    ...
    private fun init() {
        ...
        driverInfoRef= database.getReference(Common2.DRIVER_INFO_REFERENCE)
