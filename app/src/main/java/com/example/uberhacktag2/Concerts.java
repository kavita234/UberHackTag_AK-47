...
public class Concerts extends AppCompatActivity {
    ...
    private final int[] pics = {R.drawable.concerts1, R.drawable.concerts2, R.drawable.concerts3, R.drawable.concerts4, R.drawable.concerts5, R.drawable.concerts6, R.drawable.concerts7, R.drawable.concerts8, R.drawable.concerts9, R.drawable.concerts10};
    ...
    private final String eventType = "Concerts";
    ...
    private void getData() {
        ...
        AndroidNetworking.get("https://api.predicthq.com/v1/events?category=concerts&limit=10")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject events) {
                        ...
                        sliderAdapter = new SliderAdapter(pics, arr.length(), new OnCardClickListener());
    ...
    private void onActiveCardChange(int pos) {
        ...
        placeSwitcher.setInAnimation(Concerts.this, animV[0]);
        placeSwitcher.setOutAnimation(Concerts.this, animV[1]);
        placeSwitcher.setText(places[pos % places.length]);

        clockSwitcher.setInAnimation(Concerts.this, animV[0]);
        clockSwitcher.setOutAnimation(Concerts.this, animV[1]);
    ...
    private class TextViewFactory implements  ViewSwitcher.ViewFactory {
        ...
        public View makeView() {
            final TextView textView = new TextView(Concerts.this);
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
                textView.setTextAppearance(Concerts.this, styleId);
            } else {
    ...
    private class ImageViewFactory implements ViewSwitcher.ViewFactory {
        @Override
        public View makeView() {
            final ImageView imageView = new ImageView(Concerts.this);
    ...
    private class OnCardClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (clickedPosition == activeCardPosition) {
                final Intent intent = new Intent(Concerts.this, DetailsActivity.class);
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    final ActivityOptions options = ActivityOptions
                            .makeSceneTransitionAnimation(Concerts.this, sharedView, "shared");
