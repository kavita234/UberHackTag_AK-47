package com.example.uberhacktag2.ui.maps
...
import com.example.uberhacktag2.DrawerUtils
import com.example.uberhacktag2.R
import com.example.uberhacktag2.data.network.NetworkService
import com.example.uberhacktag2.utils.AnimationUtils
import com.example.uberhacktag2.utils.MapUtils
import com.example.uberhacktag2.utils.PermissionUtils
import com.example.uberhacktag2.utils.ViewUtils
...
class MapsActivity : DrawerUtils(), MapsView, OnMapReadyCallback  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val rootView: View =
            layoutInflater.inflate(R.layout.activity_maps, frameLayout)
        txt_menuTitle.text = "Maps"
    ...
    override fun informTripEnd() {
        ...
        destinationMarker?.remove()
        count++
        Log.e("Total rides", count.toString())
    }
